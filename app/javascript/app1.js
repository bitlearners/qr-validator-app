  ...
  window.addEventListener('load', function () {
    ...
    switch (body.attr('data-page')) {
        ...
        case "landing":
            ...
            var introswiper = new Swiper(".introslides", {
        ...
        case 'index':
            ...
            /* PWA add to phone Install app button */
            var btnAdd = document.getElementById('addtohome');
        ...
        case 'stats':
            ...
            gradient3.addColorStop(0, 'rgba(255, 84, 101, 0.6)');
            gradient3.addColorStop(1, 'rgba(255, 84, 101, 0)');
